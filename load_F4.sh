...
if [[ "$1" == "" ]]; then
	...
	echo "Possible values are : vcp / ledappli / rndis / rndisappli"
	exit 1
fi
...
VCP_BIN=$(double_backslash $(double_backslash $(conv_path_for_win "$ROOTDRIVE/d/Users/fpaut/dev/STM32_Toolchain/dt-arm-firmware/ODS/vcp/bin405/vcp.bin")))
APPLI_BIN=$(double_backslash $(double_backslash $(conv_path_for_win "$ROOTDRIVE/d/Users/fpaut/dev/STM32_Toolchain/dt-arm-firmware/ODS/LEDappli/bin/LEDappli.bin")))
RNDIS_BIN=$(double_backslash $(double_backslash $(conv_path_for_win "$ROOTDRIVE/d/Users/fpaut/dev/STM32_Toolchain/dt-arm-firmware/ODS/RNDIS/bin/rndis.bin")))
RNDIS_APPLI=$(double_backslash $(double_backslash $(conv_path_for_win "$ROOTDRIVE/d/Users/fpaut/dev/STM32_Toolchain/dt-arm-firmware/ODS/RNDIS/bin/rndis_appli.bin")))
