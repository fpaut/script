...
RNDIS_BIN=$(double_backslash $(double_backslash $(conv_path_for_win "$ROOTDRIVE/c/Users/fpaut/dev/STM32_Toolchain/dt-arm-firmware/ODS/RNDIS-F7/bin/rndis-F7.bin")))
RNDIS_BIN2=$(double_backslash $(double_backslash $(conv_path_for_win "$ROOTDRIVE/c/Users/fpaut/dev/STM32_Toolchain/dt-arm-firmware/ODS/RNDIS-F7/bin/rndis-F7ext.bin")))
APPLI_BIN=$(double_backslash $(double_backslash $(conv_path_for_win "$ROOTDRIVE/c/Users/fpaut/dev/STM32_Toolchain/dt-arm-firmware/ODS/LEDappli/bin7/LEDappli.bin")))
