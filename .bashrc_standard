...
if [ -e /cygdrive ]; then 
	# Using Cygwin
	source /cygdrive/c/Users/fpaut/dev/scripts/.bashrc_cygwin.sh
else
	if [ -e /mnt ]; then 
		# Using Ubuntu bash for Windows
		source /mnt/c/Users/fpaut/dev/scripts/.bashrc_winbash.sh
	else
		# Using msys
		source /c/Users/fpaut/dev/scripts/.bashrc_msys.sh
	fi
fi
...
alias cdd="cd $ROOTDRIVE/c/Users/fpaut/dev/STM32_Toolchain"
alias cdf="cd $ROOTDRIVE/c/Users/fpaut/dev/STM32_Toolchain/dt-arm-firmware"
alias cds="cd $ROOTDRIVE/c/Users/fpaut/dev/scripts"
